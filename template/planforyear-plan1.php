...
<table class='table table-bordered table-hover table-condensed list-object'>
    <tr>
        ...
        <th id='thidw'>Январь</th>
        <th id='thide'>Февраль</th>
        <th id='thidr'>Март</th>
        <th id='thidt'>Апрель</th>
        <th id='thidy'>Май</th>
        <th id='thidu'>Июнь</th>
        <th id='thidi'>Июль</th>
        <th id='thido'>Август</th>
        <th id='thidp'>Сентябрь</th>
        <th id='thida'>Октябрь</th>
        <th id='thids'>Ноябрь</th>
        <th id='thidd'>Декабрь</th>
    </tr>";
