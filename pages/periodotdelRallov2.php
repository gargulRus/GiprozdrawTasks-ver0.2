...
if($posnum==11){
    echo '
    <div class="title-pc" >
    <h2>План работ Стадии П отдела ОВ-Беляков по всем объектам</h2>
    </div>
    <br>
    <div class="periodBtn">
    <a href="/?page=periodotdelRov1.php&title='.$title.'&posnum='.$posnum.'" class="btn btn-gipro sendtest">ОВ-Семенова</a>
    <a href="/?page=periodotdelRov2.php&title='.$title.'&posnum='.$posnum.'" class="btn btn-gipro sendtest">ОВ-Беляков</a>
    </div>
    <br>
    <div class="periodBtn">
    <a href="/?page=periodotdelRov2.php&title='.$title.'&posnum='.$posnum.'" class="btn btn-gipro sendtest">На сегодня</a>
    <a href="/?page=periodotdelRallov2.php&title='.$title.'&posnum='.$posnum.'" class="btn btn-gipro sendtest">На все времся</a>
    </div>
    </div>';
}else{
echo '
