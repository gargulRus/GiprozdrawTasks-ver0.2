...
$name4 = "StadiaP"; 
$name4 = $name4."-".date("Y-m-d_H_i");
$name5 = "StadiaR"; 
$name5 = $name5."-".date("Y-m-d_H_i");

exec('/var/www/html3/plugins/wkhtmltox/bin/wkhtmltoimage http://192.168.62.231:82/?page=main-guest.php /var/www/html3/tableshoots/'.$name2.'.jpg' );
echo "JPG-Main Created Successfully";
exec('/var/www/html3/plugins/wkhtmltox/bin/wkhtmltoimage http://192.168.62.231:82/?page=planforyear-guest.php /var/www/html3/tableshoots/'.$name.'.jpg' );
echo "JPG-Planyear Created Successfully";
exec('/var/www/html3/plugins/wkhtmltox/bin/wkhtmltoimage http://192.168.62.231:82/?page=planforyear-plan.php /var/www/html3/tableshoots/'.$name3.'.jpg' );
echo "JPG-PlanyearPlan Created Successfully";
exec('/var/www/html3/plugins/wkhtmltox/bin/wkhtmltoimage http://192.168.62.231:82/?page=plancontrol-guest.php /var/www/html3/tableshoots/'.$name4.'.jpg' );
echo "JPG-StadiaP Created Successfully";
exec('/var/www/html3/plugins/wkhtmltox/bin/wkhtmltoimage http://192.168.62.231:82/?page=plancontrolR-guest.php /var/www/html3/tableshoots/'.$name5.'.jpg' );
echo "JPG-StadiaR Created Successfully";


$mail = new PHPMailer;
$mail->setFrom('info@giprozdraw.ru', 'Gipro-Bot');
$mail->addAddress('itgabaraev@giprozdraw.ru', ' ');
...
$mail->addAttachment('/var/www/html3/tableshoots/'.$name4.'.jpg');  
$mail->addAttachment('/var/www/html3/tableshoots/'.$name5.'.jpg');  
