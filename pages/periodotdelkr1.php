...
if($posnum==4){
    ...
    <br>
    <div class="periodBtn">
    <a href="/?page=periodotdelkr1.php&title='.$title.'&posnum='.$posnum.'" class="btn btn-gipro sendtest">КР-Глазков</a>
    <a href="/?page=periodotdelkr2.php&title='.$title.'&posnum='.$posnum.'" class="btn btn-gipro sendtest">КР-Жукова</a>
    </div>
    <br>
    <div class="periodBtn">
    <a href="/?page=periodotdelkr1.php&title='.$title.'&posnum='.$posnum.'" class="btn btn-gipro sendtest">На сегодня</a>
    <a href="/?page=periodotdelallkr1.php&title='.$title.'&posnum='.$posnum.'" class="btn btn-gipro sendtest">На все времся</a>
    </div>
    </div>';
}else{
echo '
