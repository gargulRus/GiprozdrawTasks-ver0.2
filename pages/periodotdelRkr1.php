...
if($posnum==3){
    echo '
    <div class="title-pc" >
    <h2>План работ Стадии П отдела КР-Глазков по всем объектам</h2>
    </div>
    <br>
    <div class="periodBtn">
    <a href="/?page=periodotdelRkr1.php&title='.$title.'&posnum='.$posnum.'" class="btn btn-gipro sendtest">КР-Глазков</a>
    <a href="/?page=periodotdelRkr2.php&title='.$title.'&posnum='.$posnum.'" class="btn btn-gipro sendtest">КР-Жукова</a>
    </div>
    <br>
    <div class="periodBtn">
    <a href="/?page=periodotdelRkr1.php&title='.$title.'&posnum='.$posnum.'" class="btn btn-gipro sendtest">На сегодня</a>
    <a href="/?page=periodotdelRallkr1.php&title='.$title.'&posnum='.$posnum.'" class="btn btn-gipro sendtest">На все времся</a>
    </div>
    </div>';
}else{
echo '
