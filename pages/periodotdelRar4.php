...
if($posnum==2){
    echo '
    <div class="title-pc" >
    <h2>План работ Стадии П отдела АР-Соловьева по всем объектам</h2>
    </div>
    <br>
    <div class="periodBtn">
    ...
    <br>
    <div class="periodBtn">
    <a href="/?page=periodotdelRar4.php&title='.$title.'&posnum='.$posnum.'" class="btn btn-gipro sendtest">На сегодня</a>
    <a href="/?page=periodotdelRallar4.php&title='.$title.'&posnum='.$posnum.'" class="btn btn-gipro sendtest">На все времся</a>
    </div>
    </div>';
}else{
echo '
...
$list = getobjectsR($posnum, gap, 11);
