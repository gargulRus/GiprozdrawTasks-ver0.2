...
if($posnum==1){
    echo '
    <div class="title-pc" >
    <h2>План работ Стадии П отдела ГИП-Яськов по всем объектам</h2>
    </div>
    <br>
    <div class="periodBtn">
    ...
    <br>
    <div class="periodBtn">
    <a href="/?page=periodotdelgip5.php&title='.$title.'&posnum='.$posnum.'" class="btn btn-gipro sendtest">На сегодня</a>
    <a href="/?page=periodotdelallgip5.php&title='.$title.'&posnum='.$posnum.'" class="btn btn-gipro sendtest">На все времся</a>
    </div>
    </div>';
}else{
echo '
