...
if($posnum==2){
    echo '
    <div class="title-pc" >
    <h2>План работ Стадии П отдела АР-Верстунина по всем объектам</h2>
    </div>
    <br>
    <div class="periodBtn">
    <a href="/?page=periodotdelRar1.php&title='.$title.'&posnum='.$posnum.'" class="btn btn-gipro sendtest">АР-Амелько</a>
    <a href="/?page=periodotdelRar2.php&title='.$title.'&posnum='.$posnum.'" class="btn btn-gipro sendtest">АР-Верстунина</a>
    <a href="/?page=periodotdelRar3.php&title='.$title.'&posnum='.$posnum.'" class="btn btn-gipro sendtest">АР-Гурьянов</a>
    <a href="/?page=periodotdelRar4.php&title='.$title.'&posnum='.$posnum.'" class="btn btn-gipro sendtest">АР-Соловьева</a>
    </div>
    <br>
    <div class="periodBtn">
    <a href="/?page=periodotdelRar2.php&title='.$title.'&posnum='.$posnum.'" class="btn btn-gipro sendtest">На сегодня</a>
    <a href="/?page=periodotdelRallar2.php&title='.$title.'&posnum='.$posnum.'" class="btn btn-gipro sendtest">На все времся</a>
    </div>
    </div>';
}else{
echo '
