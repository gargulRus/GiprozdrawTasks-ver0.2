...
if($posnum==3){
    ...
    <br>
    <div class="periodBtn">
    <a href="/?page=periodotdelar1.php&title='.$title.'&posnum='.$posnum.'" class="btn btn-gipro sendtest">АР-Амелько</a>
    <a href="/?page=periodotdelar2.php&title='.$title.'&posnum='.$posnum.'" class="btn btn-gipro sendtest">АР-Верстунина</a>
    <a href="/?page=periodotdelar3.php&title='.$title.'&posnum='.$posnum.'" class="btn btn-gipro sendtest">АР-Гурьянов</a>
    <a href="/?page=periodotdelar4.php&title='.$title.'&posnum='.$posnum.'" class="btn btn-gipro sendtest">АР-Соловьева</a>
    </div>
    <br>
    <div class="periodBtn">
    <a href="/?page=periodotdelar4.php&title='.$title.'&posnum='.$posnum.'" class="btn btn-gipro sendtest">На сегодня</a>
    <a href="/?page=periodotdelallar4.php&title='.$title.'&posnum='.$posnum.'" class="btn btn-gipro sendtest">На все времся</a>
    </div>
    </div>';
}else{
echo '
...
$list = getobjectsP($posnum, gap, 11);
