...
if($posnum==2){
    echo '
    <div class="title-pc" >
    <h2>План работ Стадии П отдела АР-Гурьянов по всем объектам</h2>
    </div>
    <br>
    <div class="periodBtn">
    ...
    <br>
    <div class="periodBtn">
    <a href="/?page=periodotdelRar3.php&title='.$title.'&posnum='.$posnum.'" class="btn btn-gipro sendtest">На сегодня</a>
    <a href="/?page=periodotdelRallar3.php&title='.$title.'&posnum='.$posnum.'" class="btn btn-gipro sendtest">На все времся</a>
    </div>
    </div>';
}else{
echo '
...
<a href="/?page=periodotdelall.php&title='.$title.'&posnum='.$posnum.'" class="btn btn-gipro sendtest">На все времся</a>
 ...
 $pos_num =array(
    ...
    $list = getobjectsR($posnum, gap, 10);
